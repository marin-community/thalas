...
from thalas.execution.types import THIS_OUTPUT_PATH, ExecutorStep, VersionedValue
...
class StepSpec:
    ...
    May be a :class:`~thalas.execution.remote.RemoteCallable` for Fray dispatch.
    """
    ...
    :class:`~thalas.execution.remote.RemoteCallable` is submitted via Fray; a
